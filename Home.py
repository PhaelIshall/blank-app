...
def main():
    ...
    st.markdown("""
            <div class="card" style="background-image: url('https://as2.ftcdn.net/jpg/01/44/06/21/1000_F_144062195_S0txkA9HM7Bbj5NvGCCXfWKyaNusRRfj.jpg'); background-size: cover; background-position: center;">
