    ...
    with col1:
        st.markdown("""
            <div class="card">
                ...
                <img src="https://drive.google.com/file/d/1Sf2VO46-C8XJKFl3B1XUZhliFuHorRmV/view?usp=drive_link" alt="Avatar" style="width:100%;border-radius: 20px; margin-top: 10px;">
